...
const FullLogo = () => (
  <svg width="178" height="24" viewBox="0 0 178 24" fill="currentColor">
    <path
      fillRule="evenodd"
...
const introModal = ({ professionalsToFind }) => (
  <IntroWrapper>
    <LogoWrapper>
      <FullLogo />
    </LogoWrapper>
    <TitleWrapper>We'll find {professionalsToFind} near you.</TitleWrapper>
    <TextWrapper>We're asking you a few questions so we can bring you the right pros.</TextWrapper>
  </IntroWrapper>
);
