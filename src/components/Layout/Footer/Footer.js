    ...
    <Footer>
          ...
          <ul className="list-reset flex">
            <li className="mr-6">
              <a className="text-blue hover:text-blue-darker" href="/">
                <svg
                  className="w-8 h-8 fill-current text-grey-dark mt-8"
                  viewBox="0 0 24 24"
            ...
            <li className="mr-6">
              <a className="text-grey-light cursor-not-allowed" href="/">
                <svg
                  className="w-8 h-8 fill-current text-grey-dark mt-8"
                  viewBox="0 0 24 24"
                  width="24"
      ...
      <FooterCol2>
        <div className="flex">
          ...
          <div className="w-1/4 px-4">
            <div className="font-bold mb-4">Customers</div>
            <div>
              <ul className="list-reset text-grey-dark">
                <li className="py-2">How it works</li>
                <li className="py-2">Safety</li>
                <li className="py-2">iPhone App</li>
                <li className="py-2">Android App</li>
                <li className="py-2">Services Near Me</li>
                <li className="py-2">Cost Estimates</li>
                <li className="py-2">How To Pages</li>
                <li className="py-2">Thumbtack Guides</li>
              </ul>
            </div>
          </div>
          <div className="w-1/4 px-4">
            <div className="font-bold mb-4">Pros</div>
            <div>
              <ul className="list-reset text-grey-dark">
                <li className="py-2">How it works</li>
                <li className="py-2">Sign up</li>
                <li className="py-2">Pro center</li>
                <li className="py-2">Success stories</li>
                <li className="py-2">Mobile app</li>
              </ul>
            </div>
          </div>
          <div className="w-1/4 px-4">
